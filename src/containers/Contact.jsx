...
import firebaseConf           from '../database/Firebase';
import Carousel               from '../components/Carousel';
import { Container,Col,Row }  from 'react-bootstrap';
import '../asset/styles/components/Contact.scss';
                  ...
                  <form onSubmit={this.sendMessage.bind(this)} ref='contactForm'>
                        <div>
                          ...
                          <div>
                            ...
                            <input type="email"  size="1000" id="email"  ref={email => this.inputEmail = email}  />
                          </div>

                          <div>
                              <label htmlFor="contactEmail">City <span className="required">*</span></label>
                          ...
                          <div className='form-group'>
                            ...
                            <input  size="1000"  id='phone'  type="text"  ref={phone => this.inputPhone = phone} />
                          </div>

                          <div>
                            <label htmlFor="contactMessage">Message <span className="required">*</span></label>
                            <textarea cols="50"  rows="15"  size="1000" id="message" ref={message => this.textAreaMessage = message}  name="contactMessage"></textarea>
                          </div>
